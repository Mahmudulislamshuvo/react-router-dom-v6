...
![Vite ডিফল্ট পেজ](<./public/01.webp>)
...
![ডিফল্ট এরর পেজ](<./public/03.webp>)

এটি রিয়্যাক্ট রাউটার এর ডিফল্ট এরর স্ক্রিন। এটি দেখতে বেশ খারাপ। আসুন আমরা আমাদের নিজস্ব এরর পেজ তৈরি করি।
...
![প্যারেন্ট লেআউট ছাড়া কন্টাক্ট রুট](<./public/05.webp>)
...
![খালি কন্টাক্ট লিস্ট](<./public/07.webp>)
...
![POST রিকোয়েস্ট এরর](<./public/08.webp>)
...
![নতুন রেকর্ড তৈরি](<./public/09.webp>)
...
![সঠিক কন্টাক্ট ডেটা](<./public/10.webp>)
...
![আপডেট হওয়া কন্টাক্ট](<./public/12.webp>)
...
![এডিট পেজে রিডাইরেক্ট](<./public/13.webp>)

এখন কিছু নতুন রেকর্ড যোগ করুন:

![অনেকগুলো কন্টাক্ট](<./public/14.webp>)
...
![অ্যাক্টিভ লিঙ্ক](<./public/15.webp>)
...
![রেকর্ড ডিলিট](<./public/17.webp>)

## প্রাসঙ্গিক এরর (Contextual Errors)

যদি `destroy` অ্যাকশনে আমরা ইচ্ছা করে একটি এরর থ্রো করি, তবে ডিফল্ট এরর পেজটি পুরো স্ক্রিন জুড়ে দেখা যাবে এবং ইউজার নেভিগেশন হারাবে।

![এরর স্ক্রিন](<./public/18.webp>)
...
![কনটেক্সচুয়াল এরর](<./public/19.webp>)

## ইনডেক্স রুট (Index Routes)

অ্যাপ লোড করলে ডানপাশে একটি ফাঁকা জায়গা দেখা যায়। এটি দেখতে ভালো লাগে না।

![ফাঁকা পেজ](<./public/20.webp>)
...
![সার্চ ইনপুট সিঙ্ক](<./public/22.webp>)
...
`useSubmit` হুক ব্যবহার করে আমরা প্রতিবার কি-স্ট্রোকের সাথে ফর্ম সাবমিট করতে পারি। কিন্তু এতে ব্রাউজারের হিস্ট্রি স্ট্যাক অনেক বড় হয়ে যায় এবং ব্যাক বাটন কাজ করা কঠিন হয়ে পড়ে।

![হিস্ট্রি স্ট্যাক](<./public/23.webp>)
...
![অপটিমিস্টিক ইউআই](<./public/25.webp>)
